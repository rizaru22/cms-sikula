...
<div class="card ml-2 mr-2">
    <div class="card-header">
        ...
        <a href="{{ route('admin.achievement.create') }}" class="btn btn-success"><i class="fas fa-plus"></i>&nbsp;Prestasi</a>
        </div>
    </div>
    <div class="card-body">
            ...
            @foreach($achievements as $item)
                <tr>
                    ...
                    <td>
                         ...
                         <a href="{{ route('admin.achievement.edit', $item->id) }}" class="btn btn-sm btn-warning"><i class="fas fa-pencil-alt"></i></a>
                        <form action="{{ route('admin.achievement.destroy', $item->id) }}" method="POST" style="display:inline-block;">
                            @csrf
                            @method('DELETE')
